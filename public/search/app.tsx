            ...
            <EuiFlexItem style={{ width: '40%' }}>
              ...
              <EuiText>
                ...
                <EuiButtonEmpty size="xs" onClick={onClickHandler} iconType="play">
                  <FormattedMessage
                    id="cssFilters.buttonText"
                    defaultMessage="Request from low-level client (data.search.search)."
                  />
                </EuiButtonEmpty>
                <EuiText size="xs" color="subdued" className="cssFilterstepDsc">
                  <FormattedMessage
                    id="cssFilters.buttonText"
                ...
                >
                  <FormattedMessage
                    id="cssFilters.searchSource.buttonText"
              ...
              <EuiText>
                ...
                >
                  <FormattedMessage
                    id="cssFilters.searchWithWarningButtonText"
                ...
                >
                  <FormattedMessage
                    id="cssFilters.searchWithErrorButtonText"
              ...
              <EuiText>
                ...
                <EuiButtonEmpty size="xs" onClick={onMyStrategyClickHandler} iconType="play">
                  <FormattedMessage
                    id="cssFilters.myStrategyButtonText"
              ...
              <EuiText>
                <EuiButtonEmpty
                  ...
                  iconType="alert"
                  data-test-subj="cssFiltersStartSession"
                >
                  <FormattedMessage
                    id="cssFilters.startNewSession"
                ...
                <EuiButtonEmpty
                  ...
                  iconType="alert"
                  data-test-subj="cssFiltersClearSession"
                >
                  <FormattedMessage
                    id="cssFilters.clearSession"
                ...
                <EuiButtonEmpty
                  ...
                  iconType="play"
                  data-test-subj="cssFiltersCacheSearch"
                >
                  <FormattedMessage
                    id="cssFilters.myStrategyButtonText"
                    defaultMessage="Request from low-level client via My Strategy"
              ...
              <EuiText>
                ...
                <EuiButtonEmpty size="xs" onClick={onServerClickHandler} iconType="play">
                  <FormattedMessage
                    id="cssFilters.myServerButtonText"
